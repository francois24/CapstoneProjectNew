...
export default function Miragerange() {
  return (
    <Card className='p-2 crdsmpleall' sx={{ maxWidth: 350, boxShadow: 0 }}>
      <CardMedia
        component="img"
        height=""
        image="https://autostar.templines.org/wp-content/uploads/2018/12/2683357056f0ab41abef6173064588_0_0.jpg"
        alt="Mirage Range"
        className='p-3'
      />
      <CardContent style={{backgroundColor: '#f3f3f3'}}>
        <Typography gutterBottom variant="" component="div" className='text-center'>
          <h5 className='fltnme'>Mirage Range</h5>
      ...
      <CardActions style={{backgroundColor: 'rgb(148, 148, 148,0.1)'}}>
        <div className='fltact'>
          ...
          <div>
            <a href='/Miragerange' className='fltrent'>RENT&#160;IT</a>
          </div>
        </div>
      </CardActions>
    </Card>
